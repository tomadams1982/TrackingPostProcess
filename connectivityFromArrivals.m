...
%                           Only produced if allOutput == 1.
    ...
    if endDate<startDate
        error('connectivityFromArrivals.m: startDate supplied (arg 4) was not later than startDate (arg 3)');
    end
    validateattributes(siteIDs, {'cell'}, ...
        {'vector'}, ...
        mfilename, 'the siteIDs', 2)
    if endDate<startDate
        error('connectivityFromArrivals.m: siteIDs supplied (arg 2) of type cell');
    end
